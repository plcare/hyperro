$(document).ready(function() {
		...
		subtract:function(num){
			var qty=$('.product-how-much').html()-0;
			var qtynew=qty-num;
			qtynew=(qtynew<5?5:qtynew);
			$('.product-how-much').html(qtynew);			
		}
	};
	$(document).ready(function(){
		setTimeout(function(){
			a.subtract(2);
			setInterval(function(){a.subtract(Math.floor(Math.random()*(4-2))+2);},(Math.floor(Math.random()*(25-20))+20)*1000);
		},2000);
	});
